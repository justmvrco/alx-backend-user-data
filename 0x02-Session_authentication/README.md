...
## [9. Expiration?](api/v1/auth/session_exp_auth.py), [app.py](api/v1/app.py)
...
## [10. Sessions in database](api/v1/auth/session_db_auth.py), [app.py](api/v1/app.py),[user_session.py](models/user_session.py)
